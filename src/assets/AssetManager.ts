...
export const NUCLEAR_ASSET_MANIFEST: AssetManifest = {
  models: {
    nuclear_plant: {
      ...
      type: 'model',
      priority: 'critical',
      metadata: { description: 'Main nuclear plant campus (procedural)' },
    },
    reactor_building: {
      path: '/models/Meshy_AI_Industrial_Machinery__0724113112_texture.glb',
      type: 'model',
      priority: 'high',
      metadata: { description: 'Industrial machinery - reactor building detail' },
    },
    industrial_vehicle: {
      path: '/models/Meshy_AI_Massive_Industrial_Ve_0724112147_texture.glb',
      type: 'model',
      priority: 'normal',
      metadata: { description: 'Massive industrial vehicle' },
    },
    fusion_core: {
      path: '/models/Meshy_AI_Neon_Core_Fusion_Blue_0724113320_texture.glb',
      type: 'model',
      priority: 'high',
      metadata: { description: 'Neon fusion core - reactor visualization' },
    },
    riverside_plant: {
      path: '/models/Meshy_AI_Riverside_Nuclear_Pow_0724180730_texture.glb',
      type: 'model',
      priority: 'normal',
      metadata: { description: 'Riverside nuclear plant variant' },
    },
  },
  textures: {},
  environments: {
